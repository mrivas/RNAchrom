...
setup(name='RNAchrom',
	...
	license='GPL',
	packages=['RNAchrom'],
	scripts=['bin/annotateBAM','bin/countHits','bin/corrWind','bin/sj','bin/specificity','bin/removeOverlapps','bin/detectLinks','bin/filterBAM','bin/countReads','bin/bamFragDistribution','bin/fixBAMmates','bin/countFragments','bin/splitBAM','bin/countReadTypes','bin/geneTargets','bin/countRestrSites','bin/plotCounts','bin/connections','bin/annotateConn','bin/vennDiagram'],
