...
There is a revolution in genomics. We are moving from analyzing the genome as string of nucleotides to exploring its cross-interactions. In this context, RNA-chromatin interactions play fundamental roles in the regulation of histone modification, and alternative splicing among other relevant biological processes.
